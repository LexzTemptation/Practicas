...
import com.org.athtec.SpringUdemy62.domain.Persona;
import com.org.athtec.SpringUdemy62.service.PersonaService;
...
public class ControladorInicio
{
    ...
    /* La anotación "@Valid" valida el formulario, y esta recupera
       los errores del mismo.
       
       En caso de que tenga errores se pasa el parametro "Errors" 
       para saber si el formulario tiene errores.
    */
    @PostMapping("/guardar")
    public String guardar(@Valid Persona persona, Errors errores)
    {
        /* Si se ha recibido errores se pregunta con el método "hasErrors()" */
